        ...
        <div className='mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl'>
                <div className='p-8'>
                    ...
                    <div className='mt-4 flex justify-between'>
                        ...
                        <button className="float-left mt-2 mb-2 bg-gray-200 rounded-lg px-3 py-1 text-sm font-semibold text-gray-700 mr-2" onClick={deleteArticle}>Delete Article</button>
                    </div>
